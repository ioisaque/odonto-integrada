...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	.login h1 a {
		...
		background-image: none,url(wp-admin/images/SIG_logo.png) !important;
	}
	</style>
	<div id="login">
		<h1><a href="http://www.sig.pro.br" title="Desenvolvido por SIG." tabindex="-1">Desenvolvido por SIG.</a></h1>
	<?php
