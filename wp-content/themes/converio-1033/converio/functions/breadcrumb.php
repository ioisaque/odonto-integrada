...
function converio_breadcrumb()
{
    ...
    elseif (is_tax('project-categories')) {
		$project_cats = get_the_terms(get_the_id(), "project-categories");
		$converio_breadcrumb_header = $project_cats[0]->name;
        echo $project_cats[0]->name;
    }
