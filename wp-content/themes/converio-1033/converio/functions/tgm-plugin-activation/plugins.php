 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Converio for publication on ThemeForest
...
function converio_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			'installing'                      => __( 'Installing Plugin: %s', 'converio' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'converio' ),
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'converio' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'converio' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'converio' ),
			'dismiss'                         => __( 'Dismiss this notice', 'converio' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'converio' ),
