...
function converio_customize_register_general($wp_customize) {
	...
	//SEO titles - post/page/product title
	$wp_customize->add_setting('main_title', array(
		'default' => 2,
		'sanitize_callback' => ''
	) );
	$wp_customize->add_control('main_title', array(
		'label' => esc_attr__('Show main post/page/project/product title as', 'converio'),
		'section' => 'general',
		'settings' => 'main_title', 
		'type' => 'radio',
		'priority' => 7,
		'choices' => array(
			1 => esc_attr__('h1', 'converio'),
			2 => esc_attr__('h2', 'converio')
		)
	));		
