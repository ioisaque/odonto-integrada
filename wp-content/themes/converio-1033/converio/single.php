	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<article class="post">
			<?php if(!$hide_title) :
				...
				<?php endif; ?>
			<?php endif;?>
			<p class="post-meta" itemprop="datePublished" content="<?php the_time('Y-m-d') ?>"><?php the_time(get_option( 'date_format')) ?><span>/</span> <?php esc_attr__('by', 'converio') ?> <span itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php the_author(); ?></span></span> <span>/</span> <?php the_category(", "); ?><?php if ( comments_open() ) : ?> <span>/</span> <?php comments_popup_link(__('0 comments', 'converio'), __('1 comment', 'converio'), __('% comments', 'converio'), ''); ?><?php endif; ?></p>
			<?php 			
