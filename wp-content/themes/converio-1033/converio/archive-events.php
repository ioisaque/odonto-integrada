...
get_header(); ?>
    ...
    <section class="content event <?php echo esc_attr($converio_sidebar_class); ?>">
...
?>
            ...
            <article class="post groups-title">
                ...
                <p class="event-day-month"><?php echo esc_attr__(date_i18n('F, Y', $date )); ?> <span><?php echo esc_attr__(date('l', $date )); ?></span></p>
            </article>
            <?php } ?>
            <?php $last_data = $date; ?>
