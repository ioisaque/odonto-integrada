		...
		if($postlist->have_posts()) :
			...
			<article <?php post_class(); ?>>
				...
				<?php if($quote_content == '' ) { ?>
					...
					<p class="post-meta"><?php the_time(get_option('date_format')) ?> <span>/</span> <?php esc_attr_e( 'by', 'converio' );?> <?php the_author(); ?> <span>/</span> <?php the_category(", "); ?><?php if ( comments_open() ) : ?> <span>/</span> <?php comments_popup_link(__('0 comments', 'converio'), __('1 comment', 'converio'), __('% comments', 'converio'), ''); ?><?php endif; ?></p>
