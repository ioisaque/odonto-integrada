...
*/
    ...
    function fontResizer_place(){
		echo '<ul class="ct-font-resizer" style="right: 0; float: right; position: absolute; margin: 65px 45px auto auto;"><li class="fontResizer ct-font-resizer-element" style="text-align: center; font-weight: bold;">';
		echo '<span style="color: #fff; font-size: 13px !important;">Zoom </span>';
		echo '<a class="fontResizer_minus ct-font-resizer-minus" href="#" title="' . __('Decrease font size', 'font-resizer') . '" style="font-size: 11px !important;">A</a> ';
		echo '<a class="fontResizer_reset ct-font-resizer-reset" href="#" title="' . __('Reset font size', 'font-resizer') . '"  style="font-size: 14px !important;">A</a> ';
		echo '<a class="fontResizer_add ct-font-resizer-plus" href="#" title="' . __('Increase font size', 'font-resizer') . '" style="font-size: 17px !important;">A</a> ';
