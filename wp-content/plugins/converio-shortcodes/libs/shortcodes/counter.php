...
function converio_counters($attr){
	...
	$output = '<ul class="'.$output_class.'" data-time="'.$time.'" data-tdays="'.$translate_days.'" data-tday="'.$translate_day.'" data-thours="'.$translate_hours.'" data-thour="'.$translate_hour.'" data-tminutes="'.$translate_minutes.'" data-tminute="'.$translate_minute.'" data-tseconds="'.$translate_seconds.'" data-tsecond="'.$translate_second.'">';
