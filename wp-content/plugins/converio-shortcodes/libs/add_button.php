	...
	<ul>
		...
		<li class="parent">
			...
			<ul>
				...
				<li><a href="#" data-all='[recent_posts number_of_columns="e.g. 4" number_of_posts="e.g. 4" excerpt_words="e.g. 40" strip_html="e.g. yes, no" title="e.g. Recent Posts" category_name = ""]'>Recent Posts</a></li>
